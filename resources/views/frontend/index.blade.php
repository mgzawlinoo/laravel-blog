            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="py-4 navbar-nav ms-auto py-lg-0">
                        <li class="nav-item"><a class="py-3 nav-link px-lg-3 py-lg-4" href="index.html">Home</a></li>
                        <li class="nav-item"><a class="py-3 nav-link px-lg-3 py-lg-4" href="about.html">Categories</a></li>
                        <li class="nav-item"><a class="py-3 nav-link px-lg-3 py-lg-4" href="contact.html">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <!-- Pager-->
                    <div class="mb-4 d-flex justify-content-end"><a class="btn btn-primary text-uppercase" href="#!">Older Posts →</a></div>
                </div>
            </div>
        </div>
        <!-- Footer-->
